public class Main {
    public static void main(String[] args) {
        ...
        if (temperatureWeather < 5) {
            System.out.println("На улице " + temperatureWeather + " градусов, нужно надеть шапку");
        } else {
            System.out.println("На улице " + temperatureWeather + " гдрадусов, можно идти без шапки");
        }
        int speed = 68;
        if (speed >= 60) {
        ...
        else if (ageMan >= 24 && ageMan <= 60) {
            System.out.println("Если возраст человека равен " + ageMan + ", то ему пора ходить на работу");
        } else {
            System.out.println("Если возраст человека равен " + ageMan + ", то его место на пенсии");
        }
        int ageChild = 8;
        if (ageChild < 5) {
        ...
        int two = 3;
        int three = 46;
        boolean isOneMoreThanTwoAndThree = one > two && one > three;
        if (isOneMoreThanTwoAndThree) {
